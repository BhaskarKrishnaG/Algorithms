...
/**
 * This is a OrganizedThreads class that tests the behaviour of StorageOfAstronomicalObject
 *
...
public class Test {
     ...
     * the state of the object is reflected in the vector.
     */
    private static void testPlanets() {
        StorageOfAstronomicalObject<Planet> planets =
                new StorageOfAstronomicalObject<Planet>("Planets");
        ...
        StorageOfAstronomicalObject.print(planets);
    }
    ...
    private static void testBinaries() {
        StorageOfAstronomicalObject<Binaries> binaries =
                new StorageOfAstronomicalObject<Binaries>("Binary");
        ...
        StorageOfAstronomicalObject.print(binaries);
    }
    ...
    private static void testAsteroids() {
        StorageOfAstronomicalObject<Asteroid> asteroids =
                new StorageOfAstronomicalObject<Asteroid>("Asteroid");
        ...
        StorageOfAstronomicalObject.print(asteroids);
    ...
    private static void testAll() {
        ...
        StorageOfAstronomicalObject.print(aStorageOfAstronomicalObject);
    }
